...
if __name__ == '__main__':
    ...
    # test_dataset = customDataset("D:\\downloads\\Finance_Dataset\\0307_test_in_train\\", transform=test_transform)
    test_dataset = customDataset("./dataset_padding_and_resize224/padding_and_resize224/test/",
